...
export default function Header() {
    ...
    <nav className="au-c-main-header__actions">
      <ul className="au-c-list-horizontal">
        <li className="au-c-list-horizontal__item">
          <a href="/ember-appuniversum/docs/patterns/au-main-header" className="active ember-view au-c-link au-c-link--secondary ">
  ...
  <a href="https://www.vlaanderen.be/" className="au-c-main-header__title au-c-main-header__title--link">
        ...
        {/* 
      <li className="au-c-list-horizontal__item">
        <div className="au-c-dropdown au-c-dropdown--right">
        <div className="au-c-dropdown__toggle">
          <div className="au-c-dropdown__name">
            Login
          </div>
        </div>
          </div>
